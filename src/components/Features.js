    ...
    <section className="bg-gray-50  py-16">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 ">¿Por qué elegirnos?</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Envío Rápido */}
          <div className="flex flex-col items-center p-8 bg-white  rounded-xl shadow-lg transition-transform transform hover:scale-105">
            <FaShippingFast className="w-16 h-16 text-teal-500 mb-6" />
            <h3 className="text-2xl font-semibold text-gray-800  mb-3">Envío Rápido</h3>
          ...
          <div className="flex flex-col items-center p-8 bg-white  rounded-xl shadow-lg transition-transform transform hover:scale-105">
            ...
            <h3 className="text-2xl font-semibold text-gray-800  mb-3">Atención 24/7</h3>
            <p className="text-center text-gray-600 ">
          ...
          <div className="flex flex-col items-center p-8 bg-white  rounded-xl shadow-lg transition-transform transform hover:scale-105">
            ...
            <h3 className="text-2xl font-semibold text-gray-800  mb-3">Devoluciones Gratis</h3>
            <p className="text-center text-gray-600 ">
